...
if(isset($_POST['newBioSubmit'])) {
	...
	$newBio = $_POST['newBio'];
	$sqlbio = "UPDATE users SET bio='$newBio' WHERE username='$userProfile' LIMIT 1";
	$query = mysqli_query($db, $sqlbio);
		...
		<div height="100%"style="margin-bottom:0%;"class="container">
			<div class="row"> 
				...
				<center style="margin-bottom:0%;">
					...
					<center><a data-target ="#password" data-toggle="modal">Edit</a></center>
				</div>
			</div>
		</div>
		...
		<div height="100%"style="margin-bottom:0%;"class="container">
			<div class="row"> 
				...
				<center style="margin-bottom:0%;">
					...
					<p><?php echo $bio;?></p>
					<a data-target ="#bioUpdate" data-toggle="modal">Edit</a>
					</div>
				</div>
			</div>
		</div>
...
<div class="modal fade" id="bioUpdate">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        <form style="margin-right:3%;" action="profilePersonal.php?author=<?php echo $user?>" method="post" enctype="multipart/form-data">
                            <textarea style="background-color: #fafafa; resize:none" rows="5" cols="50" class="form-control" placeholder="<?php echo $bio; ?>" name="newBio" type="text"></textarea>
                            <br>
                            <input  class="btn btn-primary" name="newBioSubmit" type="submit" value="Submit">
                            <br>
                        </form>
      </div>
